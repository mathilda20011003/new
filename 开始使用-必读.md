...
2. **创建 API Key**
   ...
   - 点击 "Create Key"
   - 输入名称：`WeChat RSS Bot`
   - 复制 API Key（类似：`sk-or-v1-xxxxxxxxxxxxx`）
   - **保存到记事本**

3. **查看可用模型**
   - 默认使用：`meta-llama/llama-3.1-8b-instruct:free`
   - 完全免费，无限制使用

**备选方案：DeepSeek**（如果你更喜欢）

1. 访问：https://platform.deepseek.com
2. 注册并创建 API Key
3. 新用户有 500 万 tokens 免费额度

📖 **详细教程**：查看 [OpenRouter使用教程.md](OpenRouter使用教程.md)
